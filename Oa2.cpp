...
double iterateK(int N, double k,boost::mt19937 &rng,int caso,double r)
{
	...
	size_t steps = integrate_adaptive(stepper, ho, x , 0.0 , 50.0*2.0*M_PI/1.4 , 0.01, push_back_state_and_time( x_vec , times )); //1 funcion. 2 condiciones iniciales. 3 tiempo inicial. 4 tiempo final. 5 dt inicial. 6 vector de posicion y tiempo
